...
bot = telebot.TeleBot("5559756358:AAGRAatZ_JAH_Fq1KkUUykZSjIE0pVVeckQ")


class DataBase:
	def __init__(self):
		cluster = MongoClient("mongodb+srv://user:12345@cluster0.y4eiiqy.mongodb.net/?retryWrites=true&w=majority")
